...
;
          if (!runningTests) {
            require("address-book/app")["default"].create({"name":"address-book","version":"0.0.0+74e2e888"});
          }
